...
export const $ = {
    scene : (ops?:SceneOptions) => (...nodes:ToolKitItem[]) => {
    ...
    box : (ops?:Widgets.BoxOptions) => (...nodes:ToolKitItem[]) : ToolKitItem => {
    ...
    customCamera: () => (camera:Camera) : ToolKitItem => ({ elements : [], cameras : [camera], storage: {}  }),
